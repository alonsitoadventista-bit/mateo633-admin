 ...
 *
 * F1: el botón de WhatsApp solo abre el chat. Los mensajes prellenados
 * (recordar renovación / recuperar / bienvenida) y su registro llegan en F4;
 * el asistente "Renovar" llega en F3.
 */
...
export function TarjetaProximaAccion({ accion, whatsapp }) {
  if (!accion) return null;
  const a = ACCIONES_CLIENTE[accion.clave] || ACCIONES_CLIENTE.ninguna;
